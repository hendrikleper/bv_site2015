...
function Universal_Display($size = 1, $chanflag = false, $descflag = true, $dateflag = true)
{
...
/* I deleted the part below to get rid of titles with included link */
...
*/
		...
		if($descflag != false)
		{
			...
			{
				$page .= "$description";
/* I deleted a <br /> before $description to get rid of the line break*/
			}
		}	
		if($dateflag != false)
		{			
